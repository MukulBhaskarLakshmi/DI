...
def my_card_details():
    Iden = "8085051020"
    pin ="2005108085"
    add = "8/3 22nd main 12th cross hnumagiri layout padmanabhanagar Bengaluru 5660061"
    typev = "Cycle"
    DOB = "05-10-2010"
    Name = "Mukul Shrihsa B"
    label_id ["text"] = Iden
    label_name["text"] = Name
    label_dob["text"] = DOB
    label_pin["text"] = pin
    label_address["text"] = add
    label_vehicle_type["text"] = typev
